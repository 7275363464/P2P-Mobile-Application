...
class ReportScreen(Screen):
    ...
    def __init__(self, **kwargs):
        ...
        self.subcategory_loan_list = [item['subcategory_loan_issue'] for item in report_data]
    ...
    def save_edited_data(self):
        ...
        if not user_profile:
            self.show_dialog("Error", "User profile not found")
            return
        ...
        if user_type != 'borrower':
            self.show_dialog("Error", "Only borrowers can report issues")
            return
