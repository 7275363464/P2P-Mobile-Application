...
class TransactionBH(Screen):
    ...
    def init_data(self):
        ...
        print("TransactionBH init_data started")
        ...
        transaction_process_start = time.time()
    ...
    def on_transaction_click(self, instance, touch):
        if instance.collide_point(*touch.pos):
            ...
            self.manager.get_screen('ViewProfileScreenBTH').initialize_with_value(transactions_id, transaction_type,
                                                                                  amount)
