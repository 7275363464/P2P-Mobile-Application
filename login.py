...
<PreLoginScreen>:
    ...
    MDFloatLayout:
        ...
        BoxLayout:
            ...
            MDTextField:
                ...
                hint_text: " Password"
                mode: "rectangle"
                hint_text_color: 0, 0, 0, 1  # Indigo color for hint text
                color_mode: 'custom'
                line_color_normal: 0.043, 0.145, 0.278, 1
                icon_right: "lock"
            ...
            MDLabel:
                ...
                font_size: dp(13)
                valign: 'center'
                on_touch_down: app.root.get_screen("prelogin").go_to_login_otp() if self.collide_point(*args[1].pos) else None
    ...
    BoxLayout:
        ...
        MDTextButton:
            text: "Don't have an account? [color=#0699FF]Sign UP[/color]"
            font_name: "Roboto"
            font_size: dp(14)
            markup: True
            theme_text_color: 'Secondary'
    ...
    BoxLayout:
        ...
        MDBoxLayout:
            ...
            MDTextField:
                ...
                hint_text: " Email ID"
                mode: "rectangle"
                helper_text: "Enter an registered email id"
                icon_right: "account"
                size_hint: 1, None
                height: dp(80)
